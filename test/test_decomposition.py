...
class TestDecomposition(unittest.TestCase):
    ...
    def _test_read_frequency_table(self):
    ...
    def _test_standard_frequency_table(self):
    ...
    def _test_decomposition_bug_4(self):
    ...
    def test_decomposition_bug_6(self):
        # This example exercises the morphic freedom rule, which used not
        # to be implemented.
        decomposition = zl.decompose(u'爱情', zl.TRADITIONAL)
